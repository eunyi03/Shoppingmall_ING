...
//   const [totalPrice, setTotalPrice] = useState(0); // 총 금액 상태
...
//           const { userData, productData } = response.data.data;
//           setUser(userData);
//           setProduct(productData);
//           setTotalPrice(productData.SellPrice + shippingFee);
//         } else {
//           alert("정보를 가져오는 데 실패했습니다.");
//         }
//       } catch (error) {
//         console.error("거래하기 데이터 가져오기 실패:", error);
//         alert("서버 오류가 발생했습니다.");
//       }
//     };
